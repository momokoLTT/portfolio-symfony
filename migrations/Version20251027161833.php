 ...
 */
final class Version20251027161833 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE credit (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(25) NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE link (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(255) NOT NULL, identifier VARCHAR(255) NOT NULL, credit_id INT NOT NULL, INDEX IDX_36AC99F1CE062FF9 (credit_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE link ADD CONSTRAINT FK_36AC99F1CE062FF9 FOREIGN KEY (credit_id) REFERENCES credit (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE link DROP FOREIGN KEY FK_36AC99F1CE062FF9');
